...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json){
    return Datum(
      ...
      biddingTime: json["bidding_time"].toString(),
      blockTime: json["block_time"].toString(),
      scheduleDay: json["schedule_day"].toString(),
      lowValue: json["low_value"].toString(),
      highValue: json["high_value"].toString(),
      bookingPercentage: json["booking_percentage"].toString(),
      image: json["image"],
