...
class QuickTechVehiclesController extends GetxController {
  ...
  var data=<Data>[].obs;
  getVehicles({required String id})async{
    ...
    var request = http.Request('GET', Uri.parse('${Urls.domain}/api/v1/customer/category/$id'));
    ...
    if (response.statusCode == 200) {
      ...
      data.clear();
      vehicleCategories.value = QuickTechGetVehicleCategories.fromJson(jsonResponse);
