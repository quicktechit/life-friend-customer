            ...
            : ListView.separated(
                ...
                itemBuilder: (context, index) {
                  final SortedTrips item =
                      _controller.allConfirmTripHistory[index];
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: confirmColor.withAlpha(50),
                                    borderRadius: BorderRadius.circular(20),
                                    border: Border.all(
                                      color: confirmColor.withAlpha(40),
                                      width: 1,
                                    ),
                                  ),
                                  child: Row(
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                if (item.rentalRelationships != null &&
                                    item.rentalRelationships!.trip!.roundTrip !=
                                        null)
                                  Container(
                                    padding: EdgeInsets.symmetric(
                                      horizontal: 12,
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      borderRadius: BorderRadius.circular(12),
                                      border: Border.all(
                                        color: Color(0xFFFF9800).withAlpha(70),
                                      ),
                                    ),
                                    child: Row(
                                      children: [
