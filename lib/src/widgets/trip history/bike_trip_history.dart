...
import 'package:pickup_load_update/src/controllers/trip%20history%20controller/bike_trip_history_controller.dart';
...
class BikeTripTripHistory extends StatefulWidget {
  BikeTripTripHistory({super.key});

  @override
  State<BikeTripTripHistory> createState() => _BikeTripTripHistoryState();
}

class _BikeTripTripHistoryState extends State<BikeTripTripHistory> {
  final BikeTripHistoryController _controller =
  Get.put(BikeTripHistoryController());
  ...
  Widget build(BuildContext context) {
    return Obx(() => _controller.isLoading.value
      ...
      child: loader(),
        ...
        ? EmptyBoxWidget(title: 'No Bike trip history available yet!', truckImage: 'assets/images/motorcycle.png',)
        : ListView.builder(
