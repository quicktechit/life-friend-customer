...
import 'package:pickup_load_update/src/controllers/trip%20history%20controller/airport_trip_history_controller.dart';
...
class AirportTripTripHistory extends StatefulWidget {
  AirportTripTripHistory({super.key});

  @override
  State<AirportTripTripHistory> createState() => _AirportTripTripHistoryState();
}

class _AirportTripTripHistoryState extends State<AirportTripTripHistory> {
  final AirportTripHistoryController _controller =
  Get.put(AirportTripHistoryController());
  ...
  Widget build(BuildContext context) {
    return Obx(() => _controller.isLoading.value
      ...
      child: loader(),
        ...
        ? EmptyBoxWidget(title: 'No AirPort trip history available yet!', truckImage: 'assets/images/empty.png',)
        : ListView.builder(
