...
import '../../controllers/trip history controller/ambulance_trip_history_controller.dart';
...
class _AmbulanceTripTripHistoryState extends State<AmbulanceTripTripHistory> {
  final AmbulanceTripHistoryController _controller =
  Get.put(AmbulanceTripHistoryController());
  ...
  Widget build(BuildContext context) {
    return Obx(() => _controller.isLoading.value
      ...
      child: loader(),
        ...
        ? EmptyBoxWidget(title: 'No Bike trip history available yet!', truckImage: 'assets/images/ambulance.png',)
        : ListView.builder(
